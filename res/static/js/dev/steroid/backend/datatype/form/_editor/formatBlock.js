...
], function (array, declare, domConstruct, lang, MemoryStore, win, registry, _Widget, _TemplatedMixin, _WidgetsInTemplateMixin, FilteringSelect, _Plugin, rangeapi, selectionapi, i18nRTE) {
	...
	var _FontDropDown = declare("dijit._editor.plugins._FontDropDown",
		[_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
			...
			postMixInProperties:function () {
				...
				this.label = i18nRTE[this.command];
