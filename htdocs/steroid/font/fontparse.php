<?php
	...
	require_once __DIR__ . "/fileread.php";

	// font classes
	require_once __DIR__ . "/OTF data/otttfont.php";

	// bind the various locations for future use
	OTTTFONT::$OTFlocation = __DIR__ . "/OTF data/";
	OTTTFONT::$TTFlocation = __DIR__ . "/OTF data/TTF classes/";
	OTTTFONT::$CFFlocation = __DIR__ . "/OTF data/CFF classes/";
	OTTTFONT::$GDlocation = __DIR__ . "/OTF data/Glyph classes/";
