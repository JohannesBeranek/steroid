...
class GlyphMoveToRule extends GlyphRule {
	...
	function toString() {
		return "'Move to' instruction, x/y: " . $this->x1 . "/" . $this->y1;
	}
}
...
class GlyphQuadCurveToRule extends GlyphParametricCurveToRule {
	...
	function toString() {
		return "'Quadratic Curve to' instruction, over control x/y: " . $this->cx . "/" . $this->cy .
...
class GlyphCubeCurveToRule extends GlyphParametricCurveToRule {
	...
	function toString() {
		return "'Cubic Curve to' instruction, over control (1) x/y: " . $this->cx1 . "/" . $this->cy1 .
...
abstract class GlyphRules {
	...
	function toAbsoluteSVG( $x, $y ) {
		$svg = "";
		foreach ( $this->instructions as $instruction ) {
			$svg .= $instruction->toAbsoluteSVG( $x, $y ) . " ";
		}
		return $svg;
	}
}
